...
const About = ()=>{
    ...
    const handleInput = (e)=>{
        const value = e.target.value; // lấy được giá trị của input đang được taggert đến
        ...
        <Row>
            ...
            <Form className="text-start" onSubmit={submitForm}>
                ...
                <Form.Group className="mb-3" controlId="formBasicEmail">
                    ...
                    <Form.Control onChange={handleInput} value={info.email} name="email" type="email" placeholder="Enter email" />
                ...
                <Form.Group className="mb-3" controlId="formBasicPassword">
                    ...
                    <Form.Control onChange={handleInput} value={info.password} name="password" type="password" placeholder="Password" />
                </Form.Group>
